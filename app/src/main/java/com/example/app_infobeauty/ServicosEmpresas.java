...
public class ServicosEmpresas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSalvar_E = (Button) findViewById(R.id.cadastrarEmpresas);
        btnSalvar_E.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sucesso_E) {
                    ...
                    AlertDialog.Builder alerta = new AlertDialog.Builder(ServicosEmpresas.this);
    ...
    public static class Empresa implements Serializable {
        ...
        public boolean equals(Object o) {
            return this.id_E == ((ServicosEmpresas.Empresa) o).id_E;
        }
