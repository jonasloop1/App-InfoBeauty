...
import com.example.app_infobeauty.databinding.FragmentNavHelpBinding;
import com.example.app_infobeauty.ui.dicas.DicasViewModel;

public class nav_help extends Fragment {

    private HelpViewModel helpViewModel;
    private FragmentNavHelpBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentNavHelpBinding.inflate(inflater, container, false);
